...
public class ScoreScreen : IScreen
{
	...
	public ScoreScreen(bool didWin, ScoreManager scoreManager, SpriteFont titleFont, SpriteFont scoreFont, GameMain game)
	{
		this.didWin = didWin;
	...
	public void Draw(SpriteBatch spriteBatch)
	{
		...
		float xLoc = 0;
		foreach (int score in scoreManager.HighScores)
		{
