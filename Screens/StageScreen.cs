...
public class StageScreen : IScreen
{
	...
	private void CleanUpMatches()
	{
		...
		if (color1Matched > 0) scoreManager.IncrementScore(color1Matched);
		if (color2Matched > 0) scoreManager.IncrementScore(color2Matched);
		if (color3Matched > 0) scoreManager.IncrementScore(color3Matched);
		if (color4Matched > 0) scoreManager.IncrementScore(color4Matched);
